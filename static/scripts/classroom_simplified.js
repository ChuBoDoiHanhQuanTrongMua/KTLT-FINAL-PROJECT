// Classroom script for handling UI and API calls
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lấy nội dung bài giảng từ API Python
    fetch(`/classroom/lectures?character=${characterName}`)
    ...
    // Hàm hiển thị từng dòng văn bản
    function writeLine() {
    ...
    // Thiết lập vị trí ban đầu cho phấn
    const blackboardRect = blackboard.getBoundingClientRect();
    ...
    // Xử lý gửi câu hỏi đến API Python
    ...
    // Xử lý sự kiện nhấn Enter trong chatbox
